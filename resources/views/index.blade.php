...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="{{ route('index') }}">Jigsaw</a></h1>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-md-8 text-center">
              <h1>Make it <span class="typed-words"></span></h1>
              <h3 class="text-white">Jigsaw Innovation Co., Ltd.</h3>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 pt-4 pt-lg-0 content" data-aos="fade-right" data-aos-delay="100">

             <p class="text-center"> {{-- fst-italic = เอียง, style="text-indent: 2.5em"--}}
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-12 col-md-6 d-flex align-items-stretch my-3" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="row">
                  ...
                  <div class="col-lg">
                    <div class="card-body" style="margin-top: 10%;">
                      <h6 class="card-text">บริษัท จิ๊กซอว์ อินโวเวชั่น จำกัด สนับสนุน ซึ่งเป็นลิขสิทธิฺของบริษัทฯ เพื่อใช้ในการแข่งขันฟุตบอลยาาวชน CMAL ฤดุกาล 2019 โดยคุณเจษฏา ฤดีกุลรุ่งโรจน์ โดยคาคหวังว่าระบบดังกล่าวจะเป็นส่วนหนึ่งในการพัฒนาวงการฟุตบอลเยาวชนในจังหวัดเชียงใหม่ และเป็นมาตรฐานที่ดีในการจัดการแข่งขันให้ยกระดับการแข่งขันฟุตบอลได้เป็นอย่างดี</h6>
                      <a target="_blank" href="http://jigsawinnovation.com/project/cmal2019/signin.php" class="btn btn-warning my-2">คลิกเพื่อเข้าใช้งาน</a>
                    </div>
                    <span>บริษัท จิ๊กซอว์ อินโนเวชั่น จำกัด</span>
                  </div>
              </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch my-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="card icon-box" style="width: 100%;">
                ...
                <span>ห้องประชุมภักดีศรีสงคราม ศูนย์ราชการ จังหวัดระยอง</span>
              </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch my-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="card icon-box" style="width: 100%;">
                ...
                <span>ณ ห้องประชุมพระรักษาเทพ ชั้นสอง ศาลากลางจังหวัดชลบุรี</span>
              </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch my-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="card icon-box" style="width: 100%;">
                ...
                <span>ณ กระกรวงยุติธรรม: สำนักงานปลัดกระทรวงยุติธรรม กรุ่งเทพมหานคร</span>
              </div>
          </div>
          ...
          <div class="d-flex justify-content-end">
            <a class="get-started-btn text-dark mt-3" href="{{ url('/portfolio') }}" target="_blank">SEE ALL</a>
          </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>
                  1569 อาคารภูฟ้าเพลส เลขที่ 177/1 หมู่ 1 ถนนคลองชลประทาน ต.ช้างเผือก อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50300
                </p>
              </div>
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>jigsawinnovation@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p> 086-322-3809 / 086-586-2599</p>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        ...
        <div class="text-center">
          <div class="footer-info">
            ...
            <p>
              <strong>Phone:</strong> 086-322-3809 / 086-586-2599<br>
              <strong>Email:</strong> jigsawinnovation@gmail.com<br>
            </p>
            <div class="social-links mt-3">
              <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
              <a href="https://www.facebook.com/JigsawInnovation" target="_bank" class="facebook"><i class="bx bxl-facebook"></i></a>
        ...
        <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3 footer-ml">
          <div class="col-lg col-md footer-links">
            <h4>PRODUCTS</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Domains</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Websites</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Online Stores</a></li>
          ...
          <div class="col-lg col-md footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Photographers</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Bloggers</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg col-md footer-links">
            <h4>COMMUNTY</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">CSR: Corporate Social Responsibility</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg col-md footer-links">
            <h4>FOLLOW</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="https://www.facebook.com/JigsawInnovation" target="_bank">Facebook</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        <p> © COPYRIGHT 2018 Jigsaw Innovation Co., Ltd.</p>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="assets/js/typed.js"></script>
            ...
            strings: [" beautiful."," loud."," tasteful."],
            typeSpeed: 80,
            backSpeed: 80,
            backDelay: 4000,
            startDelay: 1000,
